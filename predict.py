...
def _main_(args):
    ...
    if 'webcam' in input_path: # do detection on the first webcam
        ...
        image_paths = [inp_file for inp_file in image_paths if (inp_file[-4:] in ['.jpg', '.png', 'JPEG', '.JPG', '.PNG'])]
        ...
        for image_path in image_paths:
            ...
            for _box in boxes:
                ...
                if score < obj_thresh:
                    continue
                box = [int(float(_box.xmin)), int(float(_box.ymin)), int(float(_box.xmax)), int(float(_box.ymax))]
                print ('{}\t{}\t{}\t{}\t{}'.format(iid, 'label:', label_name, score, box))
